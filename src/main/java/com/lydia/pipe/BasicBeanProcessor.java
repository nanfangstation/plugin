...
import com.lydia.group.ComponentGroup;
import com.lydia.group.ConfigurationGroup;
import com.lydia.group.OneselfListenerGroup;
import com.lydia.group.RepositoryGroup;
...
public class BasicBeanProcessor implements PluginPipeProcessor {
    ...
    private String resolveAopClass(String pluginId, Class<?> aClass) {
        PluginOperationInfo operatorPluginInfo = GlobalRegistryInfo.getPluginInstallNum(pluginId);
        ...
        PluginOperationInfo.OperationType operatorType = operatorPluginInfo.getOperationType();
        if (operatorType == PluginOperationInfo.OperationType.INSTALL) {
